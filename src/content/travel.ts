...
export const transportRoutes: readonly TransportRouteDefinition[] = [
  ...
  { id: "mistwater-crystal-ferry", fromRegionId: "mistwater-coast", toRegionId: "crystal-depths", mode: "ferry", costCrowns: 240, durationDays: 2, requiredUnlockId: "late-game-continent" },
  { id: "stormpeak-dragonspine-airship", fromRegionId: "stormpeak", toRegionId: "dragonspine", mode: "airship", costCrowns: 320, durationDays: 1, requiredUnlockId: "late-game-continent" },
  { id: "dragonspine-deep-rail", fromRegionId: "dragonspine", toRegionId: "the-deep", mode: "rail", costCrowns: 180, durationDays: 1, requiredUnlockId: "late-game-continent" },
  { id: "crystal-deep-ferry", fromRegionId: "crystal-depths", toRegionId: "the-deep", mode: "ferry", costCrowns: 120, durationDays: 1, requiredUnlockId: "late-game-continent" },
  { id: "deep-rift-ferry", fromRegionId: "the-deep", toRegionId: "rift", mode: "ferry", costCrowns: 210, durationDays: 2, requiredUnlockId: "late-game-continent" },
];
