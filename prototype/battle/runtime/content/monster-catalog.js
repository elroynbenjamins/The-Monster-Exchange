...
import { GAME_TYPES,                                                                } from "../core/types.js";
import { GENERATED_V47_CONCEPTS, GENERATED_V47_EVOLUTIONS, GENERATED_V47_INTEGRATIONS, GENERATED_V47_MARKET_VALUES, GENERATED_V47_PASSIVES, GENERATED_V47_STATS } from "./generated-v47.js";
...
export const MONSTER_CONCEPTS                            = GENERATED_V47_CONCEPTS.map((concept) => ({
  ...concept,
...
function buildStats(concept                )        {
  const canonical = GENERATED_V47_STATS[slug(concept.name)                                    ];
...
const LEGACY_CATALOG_EVOLUTIONS                                 = [...conceptsByLine.values()].flatMap((line) =>
...
export const CATALOG_EVOLUTIONS                                 = GENERATED_V47_EVOLUTIONS;

export const CATALOG_SKILLS                             = [...GAME_TYPES.flatMap((type) => {
  const [basicName, advancedName] = TYPE_SKILL_NAMES[type];
  const statusId = TYPE_STATUS[type];
  return [
    { id: `type-${type}-basic`, name: basicName, type, power: 42, energyCost: 20, cooldown: 0, target: "enemy"         , ...(statusId ? { statusId, statusChance: 0.12 } : {}) },
    { id: `type-${type}-advanced`, name: advancedName, type, power: 67, energyCost: 45, cooldown: 2, target: "enemy"         , ...(statusId ? { statusId, statusChance: 0.28 } : {}) },
  ];
}),
...
export const CATALOG_PASSIVES                               = GENERATED_V47_PASSIVES;

export const CATALOG_SPECIES                               = MONSTER_CONCEPTS.map((concept) => {
