...
3. **Combat depth (in progress)** — deterministic speed-timeline battles now support the complete centralized 18-type chart, three active/two reserve teams, action-cost switching, Energy, cooldowns, data-defined stackable statuses, damage-over-time, control, healing, cleansing, shields, weighted AI, XP, reputation, fame, and persistent battle records. Next: richer status interactions, manual reserve replacement, equipment, team synergies, boss triggers, and battle rewards beyond XP.
