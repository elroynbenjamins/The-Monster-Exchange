...
2. **Playable loop (in progress)** — versioned/migrated autosaves, inventory/currency, resumable expedition nodes, health/stamina, retreat/defeat, capture, marketplace purchases/player selling, NPC listings, roster commands, equipment loadouts, species research, timed breeding, evolution, homebase construction/upgrades, risk/reward expedition approaches, and team-based hazard protection are connected. Next: research-facility bonuses, bosses, and a visual client.
